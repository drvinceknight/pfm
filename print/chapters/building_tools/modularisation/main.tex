...
The \index{fundamental matrix} of an absorbing \index{Markov} chains has a number of potential
...
until absorption from the first state of the \index{Markov} chains with the following transition 
matrices:
\begin{enumerate}
