...
\label{\detokenize{building-tools/05-modularisation/introduction/main:modularisation}}\label{\detokenize{building-tools/05-modularisation/introduction/main:id1}}\label{\detokenize{building-tools/05-modularisation/introduction/main::doc}}
...
To be able to code this you want to write a function to compute \(t\) but this
...
We will also import \texttt{numpy} and use it to read the data file:
